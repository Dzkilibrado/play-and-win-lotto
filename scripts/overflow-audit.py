...
ROUTES = ["/","/login","/signup","/forgot-password","/reset-password","/complete-profile","/terms","/privacy","/dashboard","/generate","/games","/games/importar","/results","/contests","/pools","/pools/new","/notifications","/profile","/settings","/admin","/statistics","/lotteries"]
