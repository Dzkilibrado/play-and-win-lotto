DROP FUNCTION public.pool_document_create(uuid, text, text, text, integer, text, integer, text);
DROP FUNCTION public.pool_document_replace(uuid, text, text, integer, text);
